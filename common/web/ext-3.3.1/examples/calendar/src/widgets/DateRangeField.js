...
Ext.calendar.DateRangeField = Ext.extend(Ext.form.Field, {
    ...
    getDT: function(startend) {
        ...
        //alert("DateRangeField getDT time "+  time  + " , Visible : " +this[startend + 'Time'].isVisible() + " , hidden " +this[startend + 'Time'].hidden );
        ...
        if (time != '' && !this[startend + 'Time'].hidden ) {

            //alert("DateRangeField getDT time 2 "+  time );
    ...
    setValue: function(v) {
        if (Ext.isArray(v)) {
            ...
            //alert("DateRangeField setValue v "+ Ext.encode(v));
            //alert("DateRangeField getValue "+ Ext.encode(this.getValue()));
        }
    ...
    setDT: function(dt, startend) {
        if (dt && Ext.isDate(dt)) {
            ...
            //alert("DateRangeField setDT "+ Ext.encode(dt));
            //alert("DateRangeField setDT "+ startend + 'Time,  ' + Ext.encode( this[startend + 'Time'].getValue() ));
