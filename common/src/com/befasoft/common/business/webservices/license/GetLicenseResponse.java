 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{}licencia" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetLicenseResponse {
    ...
    protected List<Licencia> _return;
     ...
     * 
     */
    public List<Licencia> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Licencia>();
        }
        return this._return;
    }
